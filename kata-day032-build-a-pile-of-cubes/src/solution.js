 ...
 * The parameter of the function findNb (find_nb, find-nb, findNb, ...) will be an integer m and you have to return the integer n such as n^3+(n-1)^3+(n-2)^3+...+1^3=m if such a n exists or -1 if
 * there is no such n.
 *
 * @param { stmr } number - The given number
 * @returns { number } Return the total number of cubes needed
 *
 * @example
